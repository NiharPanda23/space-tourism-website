  ...
  return (
    <div className="w-full bg-cover h-screen bg-no-repeat home bg-blend-soft-light flex flex-col lg:flex-row lg:justify-between">
      ...
      <div className="flex flex-col mt-10 mx-auto lg:w-1/2 lg:ml-12 lg:mt-8">
        ...
        <p className="text-center font-thin text-[15px] tracking-wider flex leading-6 flex-wrap line mx-8 md:mx-32 md:text-[18px] md:leading-9 lg:mx-9 lg:text-left lg:text-[20px] lg:-mt-8 lg:leading-10 text-lavender-0">
      ...
      <div className="lg:w-1/2 ">
        <div className="bg-light-0 mt-20 mx-auto rounded-full b w-48 h-48 flex border-spacing-1 hover:shadow-[0px_0px_30px_5px_#90CDF4] md:my-36 md:w-64 md:h-64 md:hover:shadow-[0px_0px_80px_10px_#90CDF4] lg:mt-[23rem] lg:w-80 lg:h-80 lg:mr-24">
